...
#
# if __name__ == '__main__':
#     detector = TFObjectDetector('./models/research/object_detection/configs/tf2',
#                                 'images_data/output', 'annotations/labels_map.pbtxt',
#                                 'ssd_mobilenet_v2_320x320_coco17_tpu-8')
#     detector.detect_image('billete1test.jpg', 'pist1test.jpg')
#     detector.detect_video('Equilibrium.mp4')
